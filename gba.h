...
#define BG_COLOR RGB(0, 19, 23)
#define GOLD RGB(31, 26, 0)
#define SILVER RGB(23, 23, 23)
#define SKY_BLUE RGB(16, 24, 28)
#define SHARK_COLOR RGB(6, 9, 19)
#define SAND_COLOR RGB(29, 23, 20)
